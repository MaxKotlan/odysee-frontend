    ...
    <Page fullWidthPage>
      <div className="notice-message--loud">
        ...
        <p className="section__subtitle">
          {/* <ul>{addItem('Channel mentioning rewrite + refactor + add support for suggesting emojis #332')}</ul> */}
          <ul>{addItem('add Player.js Support #378')}</ul>
          <ul>{addItem('[oEmbed] some changes and fixes #392')}</ul>
        </p>
      </div>
